...
![Skill Generation](https://i.imgur.com/uduRcAb.png){:.img-fluid}
...
![Create Campaign Preset](https://i.imgur.com/m0BBFEB.png){:.img-fluid}
...
We think we now have a [workaround for Mac Operating Systems](https://megamek.org/wiki/mac_issues.html).
...
+ PR #3177: Properly reveal vibrabombs detonated during a unit's movement allows active probes to reveal minefields during movement as per TacOps Active Probe rules (unit movement stops if a minefield is revealed) prevent soft-lock when stopping a unit's movement due to minefield detonation with "simultaneous movement phase" turned on
...
+ Data: Numerous Fluff entries added, new sprites, new camos, and largest board in MegaMek added Stonewall072 Ocoee (50x700)
